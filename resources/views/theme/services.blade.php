			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarsFurni">
					<ul class="custom-navbar-nav navbar-nav ms-auto mb-2 mb-md-0">
						...
						<li><a class="nav-link" href="{{ route('funi.about') }}">About us</a></li>
						<li class="active"><a class="nav-link" href="{{ route('funi.services') }}">Services</a></li>
						<li><a class="nav-link" href="blog.html">Blog</a></li>
						<li><a class="nav-link" href="{{ route('funi.contact') }}">Contact us</a></li>
					</ul>
